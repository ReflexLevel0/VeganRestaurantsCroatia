...
public class RestaurantBase(string name, string address, int zipcode, double latitude, double longitude, string? phone, string? openingHours, bool delivery, string city)
{
	/// <summary>
	/// Restaurant name
	/// </summary>
